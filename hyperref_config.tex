...
\hypersetup{
  pdftitle      = {Information extraction from handwritten forms},
  pdfauthor     = {Ciprian Tomoiaga},
  pdfsubject    = {Handwriting recognition},
  pdfkeywords   = {handwriting recognition; computer vision},
  ...
  % filecolor    = {black},  % Colour of citations
