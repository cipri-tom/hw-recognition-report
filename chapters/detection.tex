...
\section{Connectionist Text Proposal Network}\label{sec:ctpn}
	...
	\subsection{RPN becomes CTPN}
		...
		\begin{figure}
			...
			\subref{fig:ctpn_arch} The architecture comprises the VGG feature extractor, succeeded by a fully-convolutional network coupled with an LSTM for fine-scale proposals.
