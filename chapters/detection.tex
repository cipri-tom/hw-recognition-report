	...
	\subsection{Results}\label{sec:frcnn_results}
		\begin{figure}[h!]
			...
			\begin{subfigure}{.49\linewidth}
				\includegraphics[width=\linewidth]{frcnns_prec_iou}
				\caption{}
				\label{fig:frcnns_prec_iou}
			\end{subfigure}
			\begin{subfigure}{.49\linewidth}
				\includegraphics[width=\linewidth]{frcnns_prec_scores}
				\caption{}
				\label{fig:frcnns_prec_scores}
			\end{subfigure}

			\begin{subfigure}{.49\linewidth}
				\includegraphics[width=\linewidth]{frcnns_recall_iou}
				\caption{}
				\label{fig:frcnns_recall_iou}
			\end{subfigure}
			\begin{subfigure}{.49\linewidth}
				\includegraphics[width=\linewidth]{frcnns_recall_scores}
				\caption{}
